...
genai.configure(api_key="AIzaSyC9hoRatHhhxlxCXxwQJ7MWKX2BpPfiAnA")  # Replace with your actual API key
...
input_lang = st.sidebar.selectbox("Choose Input Language", ["English", "Spanish", "French", "German", "Hindi", "Telugu"])
output_lang = st.sidebar.selectbox("Choose Output Language", ["English", "Telugu", "Hindi"])
...
# Footer
st.sidebar.markdown("---")
st.sidebar.markdown("🔗 Developed by Prudhvi and Hutesh")
